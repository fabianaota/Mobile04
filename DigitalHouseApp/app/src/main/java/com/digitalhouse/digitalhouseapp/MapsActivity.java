...
public class MapsActivity extends FragmentActivity implements OnMapReadyCallback, LocationListener {
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        LatLng digitalHouse = new LatLng(-23.602751, -46.675418);
        mMap.addMarker(new MarkerOptions().position(digitalHouse).title("Digital House Coding " +
                "School"));
        mMap.moveCamera(CameraUpdateFactory.newLatLng(digitalHouse));
